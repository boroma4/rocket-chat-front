                    ...
                    <Col sm={12} xs={12} md={8} xl={8} lg={8} >
                        <Tab.Content className = 'white ma3'>
                            <Tab.Pane eventKey="first">
                                A: You send messages to other people, could you imagine!!!
                            </Tab.Pane>
                            <Tab.Pane eventKey="second">
                                A: Please register, then add other people and talk to them as much as you want. Please mind the warning above when you submit any data.
                            </Tab.Pane>
                            <Tab.Pane eventKey="third">
                                A: Bohdan Boss and Artem Daddy :))
                            </Tab.Pane>
                            <Tab.Pane eventKey="fourth">
                                A: Show WhatsApp and Telegram how to make good apps...
                            </Tab.Pane>
